...
class Main2Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    lateinit var currentTVFragment: TVFragment
    lateinit var currentRadioFragment: RadioFragment
    var isTV = false

    override fun onKeyDown(keyCode: Int, event: KeyEvent?): Boolean {
        if ((keyCode == KeyEvent.KEYCODE_VOLUME_DOWN || keyCode == KeyEvent.KEYCODE_VOLUME_UP) && isTV) {
            currentTVFragment.onVolume(keyCode)
